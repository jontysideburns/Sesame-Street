...
-- case_type: management_case, credit_case, combined_downside
...
CREATE TABLE IF NOT EXISTS forecast_cases (
  ...
  case_type TEXT NOT NULL,              -- management_case, credit_case, combined_downside
...
-- 3-tier forecast comparison: management_case (priority 1, drives grade), credit_case (priority 2), combined_downside (priority 3, floor/alarm)
-- Deal 1: Aurora
...
INSERT INTO forecast_cases (id, deal_id, case_key, case_name, case_type, comparison_priority, drives_monitoring, owner_name, summary, created_at) VALUES (2, 1, 'aurora-lender', 'Aurora Credit Case', 'credit_case', 2, FALSE, 'Borrower FP&A', 'Secondary comparator provided by the borrower/sponsor for lender reference.', '2026-08-20T09:00:00Z');
...
INSERT INTO forecast_cases (id, deal_id, case_key, case_name, case_type, comparison_priority, drives_monitoring, owner_name, summary, created_at) VALUES (5, 2, 'granite-lender', 'Granite Credit Case', 'credit_case', 2, FALSE, 'HAM - Granite', 'Credit case comparator for Granite.', '2026-07-01T09:00:00Z');
...
INSERT INTO forecast_cases (id, deal_id, case_key, case_name, case_type, comparison_priority, drives_monitoring, owner_name, summary, created_at) VALUES (8, 3, 'meridian-lender', 'Meridian Credit Case', 'credit_case', 2, FALSE, 'HAM - Meridian', 'Credit case comparator for Meridian.', '2026-07-01T09:00:00Z');
...
INSERT INTO forecast_cases (id, deal_id, case_key, case_name, case_type, comparison_priority, drives_monitoring, owner_name, summary, created_at) VALUES (11, 4, 'ion-lender', 'Ion Harbor Credit Case', 'credit_case', 2, FALSE, 'PM - Infrastructure', 'Credit case comparator for Ion Harbor.', '2026-07-01T09:00:00Z');
...
INSERT INTO forecast_cases (id, deal_id, case_key, case_name, case_type, comparison_priority, drives_monitoring, owner_name, summary, created_at) VALUES (14, 5, 'summit-lender', 'Summit Credit Case', 'credit_case', 2, FALSE, 'HAM - Summit', 'Credit case comparator for Summit.', '2026-07-01T09:00:00Z');
...
INSERT INTO forecast_cases (id, deal_id, case_key, case_name, case_type, comparison_priority, drives_monitoring, owner_name, summary, created_at) VALUES (17, 6, 'cobalt-lender', 'Cobalt Credit Case', 'credit_case', 2, FALSE, 'HAM - Cobalt', 'Credit case comparator for Cobalt.', '2026-07-01T09:00:00Z');
...
INSERT INTO forecast_cases (id, deal_id, case_key, case_name, case_type, comparison_priority, drives_monitoring, owner_name, summary, created_at) VALUES (20, 7, 'apollo-lender', 'Apollo Credit Case', 'credit_case', 2, FALSE, 'HAM - Apollo', 'Credit case comparator for Apollo Edge.', '2026-09-12T09:45:00Z');
...
INSERT INTO forecast_case_versions (id, forecast_case_id, version_number, version_label, version_status, source_domain, summary, effective_from, activated_at, is_active) VALUES (3, 2, 1, 'Credit v1', 'active', 'borrower_reforecast', 'Borrower-supplied credit case provided after the Q2 close.', '2026-08-20', '2026-08-20T09:00:00Z', TRUE);
...
INSERT INTO forecast_case_versions (id, forecast_case_id, version_number, version_label, version_status, source_domain, summary, effective_from, activated_at, is_active) VALUES (6, 5, 1, 'Credit v1', 'active', 'borrower_reforecast', 'Granite lender comparator.', '2026-07-01', '2026-07-01T09:03:00Z', TRUE);
...
INSERT INTO forecast_case_versions (id, forecast_case_id, version_number, version_label, version_status, source_domain, summary, effective_from, activated_at, is_active) VALUES (9, 8, 1, 'Credit v1', 'active', 'borrower_reforecast', 'Meridian lender comparator.', '2026-07-01', '2026-07-01T09:03:00Z', TRUE);
...
INSERT INTO forecast_case_versions (id, forecast_case_id, version_number, version_label, version_status, source_domain, summary, effective_from, activated_at, is_active) VALUES (12, 11, 1, 'Credit v1', 'active', 'borrower_reforecast', 'Ion Harbor lender comparator.', '2026-07-01', '2026-07-01T09:03:00Z', TRUE);
...
INSERT INTO forecast_case_versions (id, forecast_case_id, version_number, version_label, version_status, source_domain, summary, effective_from, activated_at, is_active) VALUES (15, 14, 1, 'Credit v1', 'active', 'borrower_reforecast', 'Summit lender comparator.', '2026-07-01', '2026-07-01T09:03:00Z', TRUE);
...
INSERT INTO forecast_case_versions (id, forecast_case_id, version_number, version_label, version_status, source_domain, summary, effective_from, activated_at, is_active) VALUES (18, 17, 1, 'Credit v1', 'active', 'borrower_reforecast', 'Cobalt lender comparator.', '2026-07-01', '2026-07-01T09:03:00Z', TRUE);
...
INSERT INTO forecast_case_versions (id, forecast_case_id, version_number, version_label, version_status, source_domain, summary, effective_from, activated_at, is_active) VALUES (21, 20, 1, 'Credit v1', 'active', 'borrower_reforecast', 'Apollo lender comparator.', '2026-09-12', '2026-09-12T09:52:00Z', TRUE);
